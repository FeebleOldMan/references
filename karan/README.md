...
**[Check if Palindrome](https://github.com/FeebleOldMan/references/blob/master/karan/text/count_vowels.py)** - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”
