...
- [Numbers](https://github.com/FeebleOldMan/references/tree/master/karan#numbers)
- [Classic Algorithms](https://github.com/FeebleOldMan/references/tree/master/karan#classic-algorithms)
- [Graph](https://github.com/FeebleOldMan/references/tree/master/karan#graph)
- [Data Structures](https://github.com/FeebleOldMan/references/tree/master/karan#data-structures)
- [Text](https://github.com/FeebleOldMan/references/tree/master/karan#text)
- [Networking](https://github.com/FeebleOldMan/references/tree/master/karan#networking)
- [Classes](https://github.com/FeebleOldMan/references/tree/master/karan#classes)
- [Threading](https://github.com/FeebleOldMan/references/tree/master/karan#threading)
- [Web](https://github.com/FeebleOldMan/references/tree/master/karan#web)
- [Files](https://github.com/FeebleOldMan/references/tree/master/karan#files)
- [Databases](https://github.com/FeebleOldMan/references/tree/master/karan#databases)
- [Graphics and Multimedia](https://github.com/FeebleOldMan/references/tree/master/karan#graphics-and-multimedia)
- [Security](https://github.com/FeebleOldMan/references/tree/master/karan#security)
...
**[Fibonacci Sequence](https://github.com/FeebleOldMan/references/blob/master/karan/numbers/fibonacci_sequence.py)** - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
...
**[Coin Flip Simulation](https://github.com/FeebleOldMan/references/blob/master/karan/numbers/coin_flip_simulation.py)** - Write some code that simulates flipping a single coin however many times the user decides. The code should record the outcomes and count the number of tails and heads.
...
**[Fizz Buzz](https://github.com/FeebleOldMan/references/blob/master/karan/text/fizz_buzz.py)** - Write a program that prints the numbers from 1 to 100. But for multiples of three print “Fizz” instead of the number and for the multiples of five print “Buzz”. For numbers which are multiples of both three and five print “FizzBuzz”.

**[Reverse a String](https://github.com/FeebleOldMan/references/blob/master/karan/text/reverse_a_string.py)** - Enter a string and the program will reverse it and print it out.

**[Pig Latin](https://github.com/FeebleOldMan/references/blob/master/karan/text/pig_latin.py)** - Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

**[Count Vowels](https://github.com/FeebleOldMan/references/blob/master/karan/text/count_vowels.py)** - Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

**[Check if Palindrome](https://github.com/FeebleOldMan/references/blob/master/karan/text/check_if_palindrome.py)** - Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

**[Count Words in a String](https://github.com/FeebleOldMan/references/blob/master/karan/text/count_words_in_a_string.py)** - Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.
